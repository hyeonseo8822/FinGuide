...
export const ALL_QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  {
    id: 4,
    question: 'ELS는 은행 예금과 똑같은 상품이다.',
    answer: 'X',
    explanation: '아니에요! 예금은 원금이 보장되지만 ELS는 원금 손실이 날 수 있어요. 완전히 다른 상품이에요.',
  },
  {
    id: 5,
  ...
  {
    id: 7,
    question: '예금은 원금을 보장받을 수 있다.',
    answer: 'O',
    explanation: '맞아요! 예금은 넣은 돈을 그대로 돌려받고, 약속한 이자도 받을 수 있어요.',
  },
  {
    id: 8,
    question: '예금은 주가가 폭락해도 돈을 잃지 않는다.',
    answer: 'O',
    explanation: '맞아요! 예금은 주가와 상관없이 약속된 이자를 받아요.',
  },
  {
    id: 9,
    question: '예금은 ELS보다 수익률이 높다.',
    answer: 'X',
    explanation: '아니에요! 예금은 안전하지만 수익이 적어요. ELS가 조건을 충족하면 더 높은 수익을 낼 수 있어요.',
  },
  {
    id: 10,
    question: '예금은 국가가 최대 5,000만 원까지 보호해 준다.',
    answer: 'O',
    explanation: '맞아요! 예금자보호법으로 1인당 최대 5,000만 원까지 국가가 보장해 줘요.',
  },
  {
    id: 11,
    question: 'ELS도 예금처럼 예금자보호법의 보호를 받는다.',
    answer: 'X',
    explanation: '아니에요! ELS는 예금자보호법 적용 대상이 아니에요. 잃어도 국가가 돌려주지 않아요.',
  },
  ...
  {
    id: 12,
    question: '안전을 원하는 사람에게는 ELS보다 예금이 더 적합하다.',
    answer: 'O',
    explanation: '맞아요! 잃으면 안 되는 돈이라면 예금처럼 안전한 상품을 선택하는 게 좋아요.',
  },
  {
    id: 13,
    question: '수익을 더 얻고 싶다면 ELS가 예금보다 유리할 수 있다.',
    answer: 'O',
    explanation: '맞아요! ELS는 조건이 충족되면 예금보다 높은 수익을 받을 수 있어요. 하지만 위험도 있다는 걸 잊지 마세요.',
  },
  {
    id: 14,
    question: '예금은 투자 결과를 미리 알 수 있다.',
    answer: 'O',
    explanation: '맞아요! 예금은 금리가 정해져 있어서 만기 때 얼마를 받을지 처음부터 알 수 있어요.',
  },
  {
    id: 15,
  ...
  {
    id: 19,
    question: 'ELS가 실패하면 예금보다 더 적게 받을 수 있다.',
    answer: 'O',
    explanation: '맞아요! ELS가 실패하면 원금 손실이 발생해서 예금이었다면 받았을 이자보다 훨씬 적게 받을 수 있어요.',
  },
  {
    id: 20,
